	...
	\begin{itemize}
		...
		\item Por esse motivo, dado um subconjunto ``tratável'' $\mathcal{I}\subseteq 2^\Omega$, definimos como $\sigma(\mathcal{I})$ a menor (no sentido da relação de inclusão $\subseteq$) $\sigma$-álgebra em $\Omega$ que contém $\mathcal{I}$.
			\begin{itemize}
				...
				$$\sigma(\mathcal{I}) = \cap_{\mathcal{A}\subseteq 2^\Omega: \mathcal{A} \text{ é $\sigma$-álgebra e }  \mathcal{A} \supseteq \mathcal{I} } \mathcal{A} \neq \emptyset\, .$$
			\end{itemize}
...
\begin{corollary}
	...
	$X^{-1}(-\infty,c] = \{\omega  \in \Omega : X(\omega) \leq c\} \in \Sigma, \quad \forall c \in \mathbb{R} \, .$
\end{corollary}
\end{frame}
