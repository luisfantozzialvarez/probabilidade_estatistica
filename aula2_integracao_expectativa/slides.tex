...
\begin{equation*}
	\begin{aligned}
		\int f d \mathbb{P}_1 \otimes \mathbb{P}_2\ = \int \left(\int f(\omega_1,\omega_2)\mathbb{P}_1[d\omega_1]\right) \mathbb{P}_2[d\omega_2] = \\ \int \left(\int f(\omega_1,\omega_2)\mathbb{P}_1[d\omega_2]\right) \mathbb{P}_2[d\omega_1] 
	\end{aligned}
\end{equation*}
