...
\end{enumerate}
\item Probabilidades condicionais regulares nem sempre existem, embora, para espaços bem-comportados como os estudados em estatística, elas quase sempre existam.
\end{itemize}
	\end{frame}
\end{document}
