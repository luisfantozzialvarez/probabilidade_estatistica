...
\begin{proof}
	...
	Mas então, da desigualdade triangular e das propriedades do valor absoluto, segue que:
	...
	demonstrando que a propriedade vale para duas sequências de $l+1$ elementos. Por indução, concluímos que a propriedade vale para qualquer $m \in \mathbb{N}$.
	
\end{proof}
\end{lemma}

Vamos usar a proposição a seguir na demonstração de \eqref{err_vanish}. Observe que, como $\lim_{n \to \infty}n|\operatorname{Err}_n|=0$, é possível encontrar $n^* \in \mathbb{N}$ tal que, para todo $n \geq n^*$:
